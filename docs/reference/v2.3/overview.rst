...
.. figure:: /images/LimeSDR-Mini_v2.3_diagrams_BD.png
  :width: 600

  Figure 3: LimeSDR Mini v2.3 board block diagram

This section contains component location description on the board. LimeSDR Mini v2.3 board picture with highlighted connectors and main components are presented in Figure 4 and Figure 5, respectively.
