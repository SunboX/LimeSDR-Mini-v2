...
FPGA GPIO header (J3) information is listed in Table 13.
...
FPGA GPIO edge header (J4) information is listed in Table 14. 

.. list-table:: Table 14. FPGA EGPIO connector (J4) pins
   :header-rows: 1
   :stub-columns: 1
